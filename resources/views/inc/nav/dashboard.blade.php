<nav class="navbar  sticky-top bg-light flex-md-nowrap p-0 shadow-sm">
  ...
  <a class="navbar-brand lblRed p-2 col-md-3 col-lg-2 mr-0 px-3" href="/dashboard">
      
    <img src="/img/index/mlqu_logo.png" width="40" height="35" class="d-inline-block align-center">
