            ...
            <table class="table table-striped table-sm ">
              <thead>
                <tr>
                  ...
                  <th class="text-center" width="15%">Subject Code</th>
                ...
                @foreach ($subjects as $subject)
                  <tr>
                    <td class="text-center">
                      <div>
                        <input type="checkbox" class="custom-checkbox" code={{$subject->subject_code}} >
                    ...
                    <td class="text-center">
                        <a class="a_icon edit" code="{{$subject->subject_code}}" units="{{$subject->units}}" category="{{$subject->category}}" subject_code="{{$subject->subject_code}}" name="{{$subject->name}}" prerequisite="{{$subject->prerequisite}}"><i data-feather="edit" class=" icon"></i></a>
                        <a class="a_icon sub_delete" subject_code="{{$subject->subject_code}}" ><i data-feather="trash-2" class=" icon"></i></a>
                    </td>
                  </tr>
                @endforeach
...
@section('script')
  ...
  @include('inc\js\dashboard\secretary\subjects') 
