                  ...
                  <table class="table table-dark" style="max-height:300px;">
                    ...
                    <thead class="" >
                      ...
                      <tr>
                        ...
                        <th class="text-center py-5 " style=" font-size:9pt;">Time</th>

                        <th class="text-center py-5 " style=" font-size:9pt;">Status</th>

                        <th class="text-center py-5 " style=" font-size:9pt;">ApprovedBy</th>
                    ...
                    <tbody class="p-2" style="background: #061325 !important;">
                      ...
                      @foreach ( $contents as $c )
                        ...
                        <tr >
                          ...
                          <td class="text-center">{{ $c->time }}</td>

                          <td class="text-center">{{ $c->status }}</td>

                          <td class="text-center">{{ $c->approvedBy }}</td>
...
@section('script')
  ...
  @include('inc\js\dashboard\developer\appointments') 
