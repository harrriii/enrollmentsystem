...
@section('content')
  ...
  <main role="main" class="col-md-8 col-lg-10  " style="background:#061325!important; ">
                  ...
                  <table class="table table-dark" style="max-height:300px;">
                    ...
                    <thead class="" >
                      ...
                      <tr>
                        ...
                        <th class="text-center py-5 " style=" font-size:9pt;">Unit No.</th>

                        <th class="text-center py-5 " style=" font-size:9pt;">Mobile No.</th>

                        <th class="text-center py-5 " style=" font-size:9pt;">Tel No.</th>
                    ...
                    <tbody class="p-2" style="background: #061325 !important;">
                      ...
                      @foreach ( $contents as $c )
                        ...
                        <tr >
                          ...
                          <td class="text-center">{{ $c->unit_no}}</td>
                          
                          <td class="text-center">{{ $c->mobile_no}}</td>
                          
                          <td class="text-center">{{ $c->tel_no}}</td>
...
@section('script')
  ...
  @include('inc\js\dashboard\developer\residents') 
