        ...
        <div class="col">
          ...
          <nav>
            ...
            <div class="nav nav-tabs " id="nav-tab" role="tablist" style="font-size: 9pt;">
              ...
              <a class="nav-link a_icon active " data-toggle="tab" href="#myEnlistment" role="tab">My Enlistments</a>
          
              <a class="nav-link a_icon" data-toggle="tab" href="#enlistment" role="tab">Enlistment</a>
                ...
                <div class="container-fluid">
                  ...
                  <div class="row pt-2" style="font-size:9pt;">
                    ...
                    <div class="col-sm-3 col-lg-2 col-xl-1 col-3 p-0">
                      ...
                      <select class="custom-select my-1 mr-lg-0 mx-sm-0 ">
                                        ...
                                        <table class="table table-striped table-sm table-hscroll" id="tbl_major" hidden>
                                          ...
                                          <thead style="font-size:10pt;">
                                            ...
                                            <tr>
                                              ...
                                              <th scope="col" ><input disabled class="chkSubject" id="checkAllMajor" type="checkbox"></th>
                                            ...
                                            @foreach ($subjects as $subject)
                                              ...
                                              @if ($subject->subjectCategory == "Major" && $subject->for_yr == $yr)
                                                ...
                                                <tr>
                                                  ...
                                                  @if ( $enlistedSubjects->contains('subject_code',$subject->subject_code))
                                                  
                                                    <td><input type="checkbox" disabled checked  p1={{$subject->prerequisite}} s="{{$subject->subject}}" u="{{$subject->units}}" c="{{$subject->subject_code}}"></td>

                                                    @else

                                                    <td><input type="checkbox"  class="chkSubject chkMajor" p1={{$subject->prerequisite}} s="{{$subject->subject}}" u="{{$subject->units}}"  c="{{$subject->subject_code}}"></td>
                                                ...
                                                @if ($subject->subjectCategory == "Minor" && $subject->for_yr == $yr)
                                                  ...
                                                  <tr>
                                                    ...
                                                    @else
                                                      ...
                                                      <td><input type="checkbox"  class="chkSubject chkMinor" p1={{$subject->prerequisite}} s="{{$subject->subject}}" u="{{$subject->units}}"  c="{{$subject->subject_code}}"></td>
                                                        
                                                      <script>

                                                        c = document.getElementById('checkAllMinor');
                                                ...
                                                @if ($subject->for_yr != $yr)
                                                  ...
                                                  <tr>
                                                    ...
                                                    @else
                                                      ...
                                                      <td><input type="checkbox"  class="chkSubject chkOther" p1={{$subject->prerequisite}} s="{{$subject->subject}}" u="{{$subject->units}}"  c="{{$subject->subject_code}}"></td>
